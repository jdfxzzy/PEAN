...
class InfoTransformer(nn.Module):
    ...
    def forward(self, src, mask_memory, query_embed, pos_embed_mem, tgt=None):
        w, bs, hc = src.shape
        ...
        memory = src
        hs = self.decoder(tgt, memory, memory_key_padding_mask=mask_memory, pos=pos_embed_mem, query_pos=query_embed)
